...
@st.cache_resource
def load_model(path_model='streamlit/model.pkl', path_scaler='streamlit/scaler.pkl'):
...
model, scaler = load_model(path_model='streamlit/model.pkl', path_scaler='streamlit/scaler.pkl')
